...
import { Plus, Trash2, Save, User, Briefcase, FolderGit2, Cpu } from 'lucide-react';
...
type Tab = 'profile' | 'experience' | 'projects' | 'skills';
...
const AdminView: React.FC = () => {
  ...
  if (loading || !profile) return <div className="pt-24 text-center text-white">Loading Admin...</div>;
      ...
      <Container>
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1">
            ...
            {/* SKILLS TAB (Simple Implementation) */}
            {activeTab === 'skills' && (
